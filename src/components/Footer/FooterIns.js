...
class FooterIns extends React.Component{
	render(){
		return(
		<footer className="pv4 ph2 tc-l">
		  <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://www.instagram.com/badminton.ina/" title="Instagram">
		  ...
		  <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2" href="https://twitter.com/inabadminton" title="Twitter">
